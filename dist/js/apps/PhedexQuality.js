...
//     Configuration: {
//         locale: 'en',
//         phedex_quality_url: "https://lcgsens01o.jinr.ru/rest/PhedexQuality/lastStatus?delta=16",
//     },
//     //============================================================================
//     //    UTILS
//     //============================================================================
...
//                                    'Done files: ' + this.done_files + '<br/>' +
//                                    'Failed files: ' + this.fail_files + '<br/>' +
//                                    'Done bytes: ' + PhedexQuality.Utils.getFileSizeUnits(this.done_bytes) + '<br/>' +
//                                    'Fail bytes: ' + PhedexQuality.Utils.getFileSizeUnits(this.fail_bytes) + '<br/>';
//                             return result;
//                         }
//                     },
//                 },]
...
//             var that = this;
//             $.ajax({
//                 url: PhedexQuality.Configuration.phedex_quality_url,
//                 success: function(data) {
//                     PhedexQuality.Model.setPhedexQuality(data.data);
//                     PhedexQuality.View.createPhedexQualityPlots('#' + that.app_name + '_AppHolder', PhedexQuality.Model.phedex_quality);
//                 }
//             });
//         }
//     },
...
//             this.Controller.instance = options.instance;
//         }

//     },
//     startApp: function(app_name) {
//         this.Controller.startApp(app_name);
//     }
// };